...
void inertia_125(const real_T q[6], real_T b_I[36])
{
  ...
  b_I[13] = (((((((((((((d_I_tmp + t18_tmp) + -t17) + d) + -t21) + t23) + t24) +
                   t71) + t26) + t27) + t29) + t69_tmp_tmp * 53.085541) -
              p_I_tmp * 2.93549) - q_I_tmp * 53.085541) + 207.22355889;
